...
original_db_path = os.path.join(original_db_directory, 'VAL_original_data.db')  # Path for reading existing data

simulated_db_directory = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'database'))
simulated_db_path = os.path.join(simulated_db_directory, 'VAL.db')  # Path for storing streamed data
