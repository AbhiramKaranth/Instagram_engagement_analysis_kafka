...
db_path = os.path.join(db_directory, 'VAL.db')
...
def simulate_data(username, topic_name, db_name, post_count=1500, bootstrap_servers='localhost:9092'):
    ...
    followers = 1200000  # Approximation of followers
    for i in range(post_count):
        post_data = {
            "timestamp": datetime.now().isoformat(),
            "post_id": f"post_{i}",
            "likes": random.randint(2000, 12000),
...
if __name__ == "__main__":
    ...
    simulate_data("valenciacf", topic_name, db_path)
